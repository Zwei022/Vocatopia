...
const TREE_FULL_ASPECT = 900 / 2865;   // 合成圖寬高比（寬/高，底部已裁掉關卡1下方多餘空白樹幹）
// 20 個關卡枝點座標（x%, y%，由合成腳本輸出並依裁切比例換算，關卡 1 在最下方）
const TREE_SLOTS = [
  { x: 75, y: 91.82 }, { x: 25, y: 86.46 }, { x: 78, y: 84.31 },
  { x: 75, y: 76.63 }, { x: 25, y: 71.28 }, { x: 78, y: 69.13 },
  { x: 75, y: 61.46 }, { x: 25, y: 56.09 }, { x: 78, y: 53.94 },
  { x: 75, y: 46.27 }, { x: 25, y: 40.91 }, { x: 78, y: 38.77 },
  { x: 75, y: 31.09 }, { x: 25, y: 25.72 }, { x: 78, y: 23.58 },
  { x: 25, y: 17.69 }, { x: 80, y: 15.01 }, { x: 28, y: 10.72 },
  { x: 68, y: 9.64 },  { x: 52, y: 5.36 },
];
